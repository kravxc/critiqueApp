      ...
      <div class="register__card">
        <div class="register__header">
          ...
          <p class="register__subtitle">
            Присоединяйтесь к сообществу меломанов
          </p>
        </div>
          ...
          <transition name="slide-fade">
            <div v-if="showSuccessNotification" class="success-notification">
              ...
              <div class="success-notification__content">
                <h4 class="success-notification__title">
                  Регистрация успешна!
                </h4>
              </div>
            </div>
        ...
        <div class="register__social">
          <button
            ...
            :disabled="showSuccessNotification || isGoogleLoading"
          >
          ...
          <button
            ...
            :disabled="showSuccessNotification || isGithubLoading"
          >
...
<style lang="scss" src="@/assets/styles/register.scss" scoped></style>
